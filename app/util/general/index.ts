 ...
 */
export function timeoutFetch(url: string, options?: RequestInit, timeout = 500): Promise<Response | unknown> {
  return Promise.race([
    fetch(url, options),
...
export function findRouteNameFromNavigatorState(routes: NavigationRoute[]): string | undefined {
