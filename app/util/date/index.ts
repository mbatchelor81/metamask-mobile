...
export function toDateFormat(timestamp: number | string): string {
 ...
 */
export const getTimeDifferenceFromNow = (timestamp: number): { days: number; hours: number; minutes: number } => {
