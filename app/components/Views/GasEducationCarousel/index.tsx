 ...
 */
export const GasEducationCarousel: React.FC<GasEducationCarouselProps> = ({
  navigation,
  route,
  conversionRate,
  currentCurrency,
      ...
      try {
        ...
        if (gasEstimates.gasEstimateType === GAS_ESTIMATE_TYPES.FEE_MARKET) {
          ...
          const gasHexes = calculateEIP1559GasFeeHexes({
            ...
            estimatedGasLimitHex: gasLimitHex, // Adding required property
          });
                  ...
                  <View key={key} style={baseStyles.flexGrow}>
                    <View style={styles.carouselImageWrapper}>
                      <Image
                        ...
                        style={[styles.carouselImage, styles[imgStyleKey as keyof typeof styles]]}
                        resizeMethod={'auto'}
                      />
                    </View>
                    <View style={baseStyles.flexGrow}>
