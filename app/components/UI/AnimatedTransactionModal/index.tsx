...
class AnimatedTransactionModal extends PureComponent<AnimatedTransactionModalProps, AnimatedTransactionModalState> {
  ...
  hideComponents = (xTranslationName: string, xTranslationEndValue: number, animationTime: string): void => {
  ...
  generateTransform = (valueType: string, outRange: number[]): { transform: any[] } => {
    const { modalValue } = this.state;
