...
class OptinMetrics extends PureComponent<OptinMetricsProps, OptinMetricsState> {
   ...
   */
  renderLegacyAction = ({ action, description, prefix }: Record<string, any>, i: number) => {
  ...
  renderAction = ({ description, prefix }: Record<string, any>, i: number) => {
    const styles = this.getStyles();
   ...
   */
  onPressLink = (linkParams: Record<string, any>) => {
...
const mapDispatchToProps = (dispatch: any) => ({
  ...
  setDataCollectionForMarketing: (value: any) =>
