...
export const getIcon = (status: string, colors: any, styles: any) => {
  switch (status) {
    case 'pending':
...
const getTitle = (status: string, { nonce, amount, assetType }: Record<string, any>) => {
  switch (status) {
    case 'pending':
...
export const getDescription = (status: string, { amount = null, type = null }: Record<string, any>) => {
